...
export class Editor {
  constructor(root, base, send) {
    ...
    this.el = {
      ...
      stopCompass: root.getElementById("editor-stop-compass"),
      stopRecordedCompass: root.getElementById("editor-stop-recorded-compass"),
      stopCompassReset: root.getElementById("editor-stop-compass-reset"),
