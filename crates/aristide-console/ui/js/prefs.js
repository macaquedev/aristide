...
export class Preferences {
  ...
  refreshOrgan(snapshot) {
    ...
    if (signature !== this.organSignature) {
    ...
    // The rebuild status runs every poll rather than only on a structural
    // change: `loading` flips independently of the shape it's rebuilding
    // towards.
