...
- **M4 — engine quality pass**: phase-aligned multi-releases, sinc resampling, voicing,
  ...
  (2026-09-02), stereo release alignment (2026-09-02), wave-trem switch on held
  notes (2026-09-02). Still open: disk streaming for sets beyond RAM; pipe-scope
  voicing, a brightness/EQ leg and live voicing edits; divisionals, stepper,
  crescendo and a piston rail; a recorded A/B against GrandOrgue.
