...
- **M4 — engine quality pass**: phase-aligned multi-releases, sinc resampling, voicing,
  ...
  (2026-09-02), stereo release alignment (2026-09-02), pipe-scope voicing with a
  brightness/EQ leg and live voicing edits (2026-09-02). Still open: disk
  streaming for sets beyond RAM; wave-trem switch on held notes;
  divisionals, stepper, crescendo and a piston rail; a
